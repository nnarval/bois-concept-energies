  ...
  const families = [
    {
      ...
      href: 'nos-produits.html?category=poeles-a-bois',
    },
    {
      ...
      href: 'nos-produits.html?category=poeles-a-granules',
    },
    {
      title: 'Inserts bois',
      count: '47 modèles',
      ...
      href: 'nos-produits.html?category=inserts-bois',
    },
    {
      ...
      href: 'nos-produits.html?category=inserts-granules',
    },
  ];
      ...
      <div className="bce-family-grid">
        {families.map((family) => (
          <figure className="bce-family-card" key={family.title}>
            ...
            <a className="bce-family-card-link" href={family.href} aria-label={`Voir le catalogue ${family.title}`}>
              Voir ce catalogue <Icon name="arrow-right" size={14} />
            </a>
          </figure>
        ))}
      </div>
